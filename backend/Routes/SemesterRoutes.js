...
const { getAllSemester, getCurrentSemester, getSelectedSemester, updatePromotionDate, getPhases, getChoiceEnd, getPromotionEnd, insertSemester, deleteSemester, updateSemester} = require('../Controller/SemesterController');
