        ...
        <div className="pl-10 pr-10 pt-5 bg-base-200 min-h-screen w-full">
          ...
          <div className="alert bg-red-200 shadow-lg mb-5">
            <div>
              ...
              <span className="font-bold text-red-800">Career choice update phase will end at {!choice ? '' : choice.choicend ? choice.choiceend.toLocaleDateString('en-GB', options): ""}</span>
            </div>
          </div>
