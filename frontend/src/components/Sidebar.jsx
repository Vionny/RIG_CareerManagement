                        ...
                        <ul className="pt-2 pb-4 space-y-1 text-sm">
                            ...
                            <li className="rounded-sm">
                                <Link
                                    ...
                                    className="flex items-center py-2 px-1 space-x-3 rounded-md"
                                >
                                    <svg
                            ...
                            <li className="rounded-sm">
                                ...
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-4">
                                        <path d="M96 32V64H48C21.5 64 0 85.5 0 112v48H448V112c0-26.5-21.5-48-48-48H352V32c0-17.7-14.3-32-32-32s-32 14.3-32 32V64H160V32c0-17.7-14.3-32-32-32S96 14.3 96 32zM448 192H0V464c0 26.5 21.5 48 48 48H400c26.5 0 48-21.5 48-48V192z" fill="white"/>
                                    </svg>
